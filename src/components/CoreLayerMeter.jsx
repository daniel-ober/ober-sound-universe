 ...
 * CoreLayerMeter
 *
 * Lightweight visual meter for a Core layer.
 * Shows a single horizontal bar whose length reflects recent FFT energy.
 *
 * Props:
...
export function CoreLayerMeter({ layerId, audioReady }) {
  ...
  useEffect(() => {
    ...
    const update = () => {
      const fft = omseEngine.getCoreLayerFFT(layerId);
      ...
      // Smooth to avoid twitchiness (slower falloff)
